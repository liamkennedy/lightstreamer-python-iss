...
# CAMERA = "USLAB000095","USLAB000096","USLAB000097","USLAB000098"
#STB_POWER = "S4000001","S4000002","S4000007"
#PRT_POWER = "P6000004","P6000005","P6000008"
# ,"USLAB000YAW","USLAB000PIT","USLAB00ROLL"
subscription = Subscription(
    mode="MERGE",
    items=["USLAB000095","USLAB000096","USLAB000097","USLAB000098","USLAB000YAW","USLAB000PIT","USLAB00ROLL"],
...
def on_item_update(item_update):
    ...
    item_full_name = "" 
    try :
       item_full_name =  PUI_NAMES[item_name]
    except :
       pass

    print "name", item_name, item_full_name
    csv_txt = item_name+","+'"'+item_full_name+'"'+","+item_value+","
